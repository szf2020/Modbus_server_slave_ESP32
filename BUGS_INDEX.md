...
| FEAT-109 | Global Save-knap i topnav | ✅ DONE | 🟡 HIGH | v7.8.4.2 | Grøn "Save"-knap i top-navigation ved siden af user-menu. Kalder `POST /api/system/save` for at gemme al konfiguration til NVS. Visuelt feedback: grøn→orange (gemmer)→grøn checkmark (gemt)/rød (fejl). Tilgængelig fra alle sider (Monitor, ST Editor, CLI, System) (web_dashboard.cpp) |
