...
// === ST Syntax Keywords ===
const ST_KW=['PROGRAM','END_PROGRAM','FUNCTION','FUNCTION_BLOCK','END_FUNCTION','END_FUNCTION_BLOCK','VAR','VAR_INPUT','VAR_OUTPUT','END_VAR','VAR_GLOBAL','IF','THEN','ELSIF','ELSE','END_IF','CASE','OF','END_CASE','FOR','TO','BY','DO','END_FOR','WHILE','END_WHILE','REPEAT','UNTIL','END_REPEAT','RETURN','EXIT','TRUE','FALSE','NOT','AND','OR','XOR','MOD'];
const ST_FN=['ABS','MIN','MAX','LIMIT','SCALE','SQRT','EXPT','LN','LOG','SEL','MUX','MOVE','HYSTERESIS','CLAMP','BIT_SET','BIT_CLR','BIT_TST','TON','TOF','TP','CTU','CTD','CTUD','SR','RS','R_TRIG','F_TRIG','SHL','SHR','ROL','ROR','MB_READ_HOLDING','MB_READ_INPUT','MB_WRITE_HOLDING','MB_WRITE_COIL'];
